...
function buildOptions(app, params, authEnabled) {
  var options = {
    url: params.url,
    logger: app.logger
  };
...
module.exports = {
  handle: function(callback) {
    ...
    utils.getParams(app, requestParams, function(err, params) {
      ...
      var options = buildOptions(app, params, authEnabled);
  ...
  usage: [
    ...
    'ystat ' +
        ...
        ' show',
     '',
     'Possible values of auth-type: ',
     '    url: login using the login url and append username and password to it'
  ]
};
